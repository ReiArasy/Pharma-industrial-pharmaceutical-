      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-12">
          {certifications.map((cert) => (
            ...
            >
              <span className="font-space font-semibold text-xs tracking-[0.15em] text-text-muted group-hover:text-accent transition-colors duration-300">
                {cert.iconText}
              </span>
        ...
        {/* Caption */}
        <p className="font-sans text-xs md:text-sm text-text-muted text-center max-w-2xl mx-auto leading-relaxed font-light">
          Our entire manufacturing pipeline is audited periodically to ensure absolute compliance with <span className="font-medium text-text">cGMP</span>, <span className="font-medium text-text">FDA guidelines</span>, and <span className="font-medium text-text">ISO 9001</span> standards, guaranteeing sterile integrity, material reliability, and enduring operational lifespans.
        </p>
